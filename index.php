...
<html lang="en">
  ...
  <div id="mycarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="welcome" id="home">
		<div class="container">
		<h3>Welcome to fitness Freak</h3>
		<div class="col-md-12">
				<div class="col-md-3">
					<span class="fa fa-book"><strong>strength training</strong></span>
				...
				<div class="col-md-3">
					<span class="fa fa-heart"><strong>CARDIO FITNESS</strong></span>
					<p>Maecenas mattis vitae tellus vel interdum. Quisque lacinia mauris id convallis pretium. Aliquam id odio sit amet mauris .</p>
				</div>
				<div class="col-md-3">
					<span class="fa fa-bitbucket"><strong>AQUATIC</strong></span>
					<p>Maecenas mattis vitae tellus vel interdum. Quisque lacinia mauris id convallis pretium. Aliquam id odio sit amet mauris .</p>
				</div>
				<div class="col-md-3">
					<span class="fa fa-group"><strong>MIND & BODY</strong></span>
					<p>Maecenas mattis vitae tellus vel interdum. Quisque lacinia mauris id convallis pretium. Aliquam id odio sit amet mauris .</p>
				</div>
